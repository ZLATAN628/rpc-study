...
public class KtHttpContext extends WebContextBase {
    static final Logger log = LoggerFactory.getLogger(KtHttpContext.class);
    ...
    public KtHttpContext(HttpRequest request, HttpResponse response, CompletableFuture<Object> future) {
        _request = request;
        _response = response;
        _future = future;
    }
